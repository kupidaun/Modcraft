...
// Silicon Press
PrecisionLaser.addRecipe(pressSilicon, lensGlass * 0, blockIron, 12000, 120);
PrecisionLaser.addRecipe(pressSilicon, lensOrdo * 0, blockIron, 12000, 120);
PrecisionLaser.addRecipe(pressSilicon, lensDiamond * 0, blockIron, 12000, 120);
PrecisionLaser.addRecipe(pressSilicon, lensDilithium * 0, blockIron, 12000, 120);
// Logic Press
PrecisionLaser.addRecipe(pressLogic, lensGreenSapphire * 0, blockIron, 12000, 120);
PrecisionLaser.addRecipe(pressLogic, lensEmerald * 0, blockIron, 12000, 120);
PrecisionLaser.addRecipe(pressLogic, lensTerra * 0, blockIron, 12000, 120);
...
// Engineering Press
PrecisionLaser.addRecipe(pressEngineering, lensAer * 0, blockIron, 12000, 120);
PrecisionLaser.addRecipe(pressEngineering, lensYellowGarnet * 0, blockIron, 12000, 120);
// Calculation Press
PrecisionLaser.addRecipe(pressCalculation, lensOpal * 0, blockIron, 12000, 120);
PrecisionLaser.addRecipe(pressCalculation, lensSapphire * 0, blockIron, 12000, 120);
PrecisionLaser.addRecipe(pressCalculation, lensAqua * 0, blockIron, 12000, 120);
PrecisionLaser.addRecipe(pressCalculation, lensBlueTopaz * 0, blockIron, 12000, 120);
